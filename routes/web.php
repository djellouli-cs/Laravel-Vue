...
//Route::inertia('/about','Address/About')->name('about');
...
//Route::get('/plage/edit', [PlageController::class, 'edit'])->name('plage.edit');
//Route::put('/plage/{id}', [PlageController::class, 'update'])->name('plage.update');// Optional: Dedicated IP address controller route
//Route::get('/about-ip', [IpAddressController::class, 'index']);
...
Route::get('/api/permanence-this-week', [PermanenceController::class, 'apiThisWeek']);
