...
function submit() {
    form.post('/permanences');
}
</script>

<template>
    <Head title="Créer une permanence" />

    <div class="max-w-4xl mx-auto py-6 px-4 sm:px-6 lg:px-8">
        <!-- Header -->
        <div class="flex justify-between items-center mb-6">
            <div>
                <h1 class="text-3xl font-bold text-gray-900">Créer une nouvelle permanence</h1>
                <p class="mt-2 text-sm text-gray-600">Définissez un nouveau planning de permanence avec les destinations</p>
            </div>
            <Link
        ...
        <form @submit.prevent="submit" class="space-y-8">
                ...
                <div class="px-6 py-4">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Début de la semaine (DSemaine) <span class="text-red-500">*</span>
                            </label>
                            <input
                                type="date"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 mb-2">
                                Fin de la semaine (FSemaine) <span class="text-red-500">*</span>
                            </label>
                            <input
                                type="date"
                    ...
                    <div class="mt-6">
                        <div class="flex justify-between items-center mb-3">
                            <label class="block text-sm font-medium text-gray-700">Sélection rapide de la semaine</label>
                            <span class="text-sm text-gray-500">Aujourd'hui : {{ currentDateDisplay }}</span>
                        </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6 mt-6">
                        <div>
                            ...
                            >
                                <option value="">Sélectionner PSemaine</option>
                                <option
                        ...
                        <div>
                            ...
                            >
                                <option value="">Sélectionner RSemaine</option>
                                <option
                                    v-for="dest in destinations"
                                    :key="dest.id"
                                    :value="dest.name"
            ...
            <div class="flex justify-end gap-4">
                ...
                >
                    ...
                    <span v-else>Créer la permanence</span>
                </button>
            </div>
        </form>
    </div>
